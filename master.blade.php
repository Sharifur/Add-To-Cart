...
<html>
  <head>
    ...
    <style>         
      ...
      .top_nav_right:hover .cart-product-item {
        opacity: 1;
        visibility: visible;
        top: 56px;
        z-index: 999999;
  ...
  <body>
    ...
    <div class="ban-top">
      <div class="container">
                    ...
                    <ul class="dropdown-menu multi-column columns-3">
                      <div class="row">
                        <div class="col-sm-6 multi-gd-img1 multi-gd-text ">
                          <a href="{{url('/')}}/mens"><img src="{{url('/')}}/asset/images/woo1.jpg" alt=" "/></a>
                        </div>
                    ...
                    <ul class="dropdown-menu multi-column columns-3">
                      <div class="row">
                        ...
                        <div class="col-sm-6 multi-gd-img multi-gd-text ">
                          <a href="{{url('/')}}/womens"><img src="{{url('/')}}/asset/images/woo.jpg" alt=" "/></a>
                        </div>
                        <div class="clearfix"></div>
                      </div>
                    </ul>
        ...
        $stitle = Session::get('stitle');
        $spicture = Session::get('spicture');
          ...
          <div class="cart box_1">
            <a href="{{url('/')}}/checkout">
              <h3> <div class="total">
                  ...
                  ৳<span id="totalAmount" class="simpleCart_total">{{$totalprice}}</span> (<span id="simpleCart_quantity" class="simpleCart_quantity">{{$countpdt}}</span> items)</div>
              </h3>
            </a>
            <div class="cart-product-item">
              ...
              if($stitle){
                for($i=0; $i<count($stitle); $i++){
                  ...
                  <div class='pdt-image'>
                    <img src='".url('/')."/images/product/{$spicture[$i]}'/>
                  </div>
                  <div class='pdt-text'><h4>{$stitle[$i]}</h4>
                  1 x ৳270
                  </div>
                    <span class='close-items' id='close-{$pdtid[$i]}'>close</span>  
                </div>";
                }
                }
                @endphp
        ...
        <div class="col-md-9 footer-right">
          ...
          <div class="sign-grds">
            ...
            <div class="col-md-4 sign-gd flickr-post">
              <h4>Flickr Posts</h4>
              <ul>
                <li><a href="single.html"><img src="{{url('/')}}/asset/images/b15.jpg" alt=" " class="img-responsive" /></a></li>
                <li><a href="single.html"><img src="{{url('/')}}/asset/images/b16.jpg" alt=" " class="img-responsive" /></a></li>
                <li><a href="single.html"><img src="{{url('/')}}/asset/images/b17.jpg" alt=" " class="img-responsive" /></a></li>
                <li><a href="single.html"><img src="{{url('/')}}/asset/images/b18.jpg" alt=" " class="img-responsive" /></a></li>
                <li><a href="single.html"><img src="{{url('/')}}/asset/images/b15.jpg" alt=" " class="img-responsive" /></a></li>
                <li><a href="single.html"><img src="{{url('/')}}/asset/images/b16.jpg" alt=" " class="img-responsive" /></a></li>
                <li><a href="single.html"><img src="{{url('/')}}/asset/images/b17.jpg" alt=" " class="img-responsive" /></a></li>
                <li><a href="single.html"><img src="{{url('/')}}/asset/images/b18.jpg" alt=" " class="img-responsive" /></a></li>
